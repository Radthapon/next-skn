import './AboutHistroy.css'

const AboutHistroy = () => {
  return (
    <div className="box max-w-md md:max-w-full mx-auto pl-4 md:pl-8 pr-8 py-4">
        <div className="flex flex-col gap-4">
            <h2 className="p1 text-xl">Welcome To S.Kijchai</h2>
            <h1 className="p2 text-3xl font-semibold">ประวัติความเป็นมาเกี่ยวกับ ส.กิจชัย</h1>
